...
public static class Moogle
{
    ...
    public static SearchResult Query(string query) 
    {
        ...
        crono.Start();
        Reader.FeedQueryWeight(QueryWeight,Reader.Clean(query),Initialize.IDF);
        ...
        for (int i =0;i<sortedResults.Count();i++){
            ...
            items[i] = new SearchItem(sortedResults.ElementAt(i).Key.Remove(0,11),Reader.Snippet(Reader.Clean(query),sortedResults.ElementAt(i).Key), Math.Round(Score.ElementAt(i).Value));
        }
